...
def setup_conditional_distributions():
    """Return conditional probability distributions for the Student network."""
    P = dict()
    I = np.matrix([0.7, 0.3])
...
def setup_student_network():
    """Return the Student Bayesian Network."""
    # Get the conditional probabilities
    P = setup_conditional_distributions()
